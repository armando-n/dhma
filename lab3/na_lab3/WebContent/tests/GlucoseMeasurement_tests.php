...
<head>
    ...
    <title>Basic tests for GlucoseMeasurement class</title>
</head>
<body>

<h1>GlucoseMeasurement class tests</h1>

<!-- output: GlucoseMeasurement object creation test -->
<h2>It should create a valid GlucoseMeasurement object when all input is provided</h2>
<?php
$validMeasurement = new GlucoseMeasurement($validInput);
...
<!-- output: get methods -->
<h2>It should call the get methods of a valid GlucoseMeasurement object and display its attribute values</h2>
...
Glucose Levels: <?=$validMeasurement->getMeasurement()?>

<!-- output: null input test -->
<h2>It should create an empty GlucoseMeasurement object when null is passed to the constructor</h2>
<?php
$invalidMeasurement1 = new GlucoseMeasurement(null);
...
<h2>It should have errors when the GlucoseMeasurement constructor is passed empty property values</h2>
<?php
$invalidMeasurement2 = new GlucoseMeasurement($emptyInputValues);
...
<h2>It should have errors and create an invalid GlucoseMeasurement object when invalid input is provided</h2>
<?php
$invalidMeasurement3 = new GlucoseMeasurement($invalidInputValues);
