...
<h1>CalorieMeasurement class tests</h1>

<!-- output: CalorieMeasurement object creation test -->
<h2>It should create a valid CalorieMeasurement object when all input is provided</h2>
<?php
$validMeasurement = new CalorieMeasurement($validInput);
...
<!-- output: get methods -->
<h2>It should call the get methods of a valid CalorieMeasurement object and display its attribute values</h2>
...
Calories Consumed: <?=$validMeasurement->getMeasurement()?>

<!-- output: null input test -->
<h2>It should create an empty CalorieMeasurement object when null is passed to the constructor</h2>
<?php
$invalidMeasurement1 = new CalorieMeasurement(null);
...
<h2>It should have errors when the CalorieMeasurement constructor is passed empty property values</h2>
<?php
$invalidMeasurement2 = new CalorieMeasurement($emptyInputValues);
...
<h2>It should have errors and create an invalid CalorieMeasurement object when invalid input is provided</h2>
<?php
$invalidMeasurement3 = new CalorieMeasurement($invalidInputValues);
