...
<head>
    ...
    <title>Basic tests for ExerciseMeasurement class</title>
</head>
<body>

<h1>ExerciseMeasurement class tests</h1>

<!-- output: ExerciseMeasurement object creation test -->
<h2>It should create a valid ExerciseMeasurement object when all input is provided</h2>
<?php
$validMeasurement = new ExerciseMeasurement($validInput);
...
<!-- output: get methods -->
<h2>It should call the get methods of a valid ExerciseMeasurement object and display its attribute values</h2>
...
Exercise Type: <?=$validMeasurement->getType()?><br />
Exercise Duration: <?=$validMeasurement->getDuration()?><br />
...
<h2>It should create an empty ExerciseMeasurement object when null is passed to the constructor</h2>
<?php
$invalidMeasurement1 = new ExerciseMeasurement(null);
...
<h2>It should have errors when the ExerciseMeasurement constructor is passed empty property values</h2>
<?php
$invalidMeasurement2 = new ExerciseMeasurement($emptyInputValues);
...
<h2>It should have errors and create an invalid ExerciseMeasurement object when invalid input is provided</h2>
<?php
$invalidMeasurement3 = new ExerciseMeasurement($invalidInputValues);
