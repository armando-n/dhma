                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-12 col-md-8">
                        <div class="input-group date date-picker">
                            ...
                            <input type="text" id="date_calorie_add" name="date" required="required" class="form-control" tabindex="3" title="yyyy-mm-dd" />
                            <span class="input-group-btn">
                        		<label for="calorie_add_date_now" class=".sr-only">Set date to today</label>
                        		<button type="button" class="btn btn-default tooltip-help today-btn" id="calorie_add_date_now" data-placement="left" title="Set the date to today">today</button>
                        	</span>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-12 col-md-8">
                        <div class="input-group date time-picker">
                            ...
                            <span class="input-group-btn">
                        		<label for="calorie_add_time_now" class=".sr-only">Set time to now</label>
                        		<button type="button" class="btn btn-default tooltip-help now-btn" id="calorie_add_time_now" data-placement="left" title="Set the time to now">now</button>
                        	</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-12 col-md-8">
                        <div class="input-group date date-picker">
                            ...
                            <input type="text" id="date_calorie_edit" name="date" required="required" class="form-control" tabindex="3" title="yyyy-mm-dd" />
                            <span class="input-group-btn">
                        		<label for="calorie_edit_date_now" class=".sr-only">Set date to today</label>
                        		<button type="button" class="btn btn-default tooltip-help today-btn" id="calorie_edit_date_now" data-placement="left" title="Set the date to today">today</button>
                        	</span>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-12 col-md-8">
                        <div class="input-group date time-picker">
                            ...
                            <span class="input-group-btn">
                        		<label for="calorie_edit_time_now" class=".sr-only">Set time to now</label>
                        		<button type="button" class="btn btn-default tooltip-help now-btn" id="calorie_edit_time_now" data-placement="left" title="Set the time to now">now</button>
                        	</span>
                        </div>
                    </div>
                </div>
...
<section id="calorie_charts_row" class="row">
    <div id="firstChart_calorie" class="col-sm-6 firstChart">
        <!-- Primary Chart -->
    </div>
    <div id="secondChart_calorie" class="col-sm-6 secondChart">
        <!-- Secondary Chart -->
    </div>
</section>
