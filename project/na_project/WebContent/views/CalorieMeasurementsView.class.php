    ...
    <div class="col-sm-12 col-md-6">
        ...
        <div class="row">
            <div class="col-sm-12 btn-group btn-group-justified" role="group">
                ...
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_individual_chart_btn_primary" class="btn btn-default btn-individual-chart active">
                        Individual
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_day_chart_btn_primary" class="btn btn-default btn-day-chart">
                        Daily
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_week_chart_btn_primary" class="btn btn-default btn-week-chart">
                        Weekly
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_month_chart_btn_primary" class="btn btn-default btn-month-chart">
                        Monthly
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_year_chart_btn_primary" class="btn btn-default btn-year-chart">
                        Yearly
                    </button>
                </div>
    ...
    <div class="col-sm-12 col-md-6 chart-secondary">
        ...
        <div class="row">
            <div class="col-sm-12 btn-group btn-group-justified" role="group">
                ...
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_individual_chart_btn_secondary" class="btn btn-default btn-individual-chart">
                        Individual
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_day_chart_btn_secondary" class="btn btn-default btn-day-chart">
                        Daily
                    </button>
                </div><div class="btn-group" role="group">
                    <button type="button" id="calorie_week_chart_btn_secondary" class="btn btn-default btn-week-chart">
                        Weekly
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_month_chart_btn_secondary" class="btn btn-default btn-month-chart active">
                        Monthly
                    </button>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" id="calorie_year_chart_btn_secondary" class="btn btn-default btn-year-chart">
                        Yearly
                    </button>
                </div>
