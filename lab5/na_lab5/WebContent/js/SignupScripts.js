...
function loadPicture() {
	...
	// show loading icon
	$('#picture-wrapper').html('<img src="/na_lab5/images/icon_loading_small.gif" class="img-responsive" alt="Loading picture icon" />');
...
function checkUserName() {
	...
	// show loading icon
	uNameHelp.html('<img src="/na_lab5/images/icon_loading_small.gif" alt="loading icon" class="img-responsive" />').parent().removeClass('has-error');
	
	// send request to server to make sure user name is not already taken
	var returnValue = false;
	$.ajax( {
		url: '/na_lab5/users_get_' + userName,
